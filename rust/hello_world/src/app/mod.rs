...
//   - shadowing
//   - data types
pub fn common_programming_concepts()
{
...
// itens:
pub fn understanding_ownership()
{
...
pub fn structs()
{
    title("Structs e Modules");

    use models::*;
    use services::CommomServices;

    let animal1 = criar_animal('C');
    animal1.emitir_som();

    let animal2 = criar_animal('G');
    animal2.emitir_som();

    // poliformismo
    CommomServices::emitir_som(animal1);
    CommomServices::emitir_som(animal2);
}
